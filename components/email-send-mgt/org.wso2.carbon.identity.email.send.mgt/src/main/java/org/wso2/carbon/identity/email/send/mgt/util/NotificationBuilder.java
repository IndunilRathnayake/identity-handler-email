...
package org.wso2.carbon.identity.email.send.mgt.util;

import org.wso2.carbon.email.mgt.dto.EmailTemplateDTO;
import org.wso2.carbon.identity.email.send.mgt.exception.EmailMgtServiceException;
...
public class NotificationBuilder {
    ...
    public static Notification createNotification(String notificationType, EmailTemplateDTO emailTemplateDTO, NotificationData data)
        ...
        if ("EMAIL".equals(notificationType)) {
            ...
            body = emailTemplateDTO.getBody();
            footer = emailTemplateDTO.getFooter();
            emailFormat = emailTemplateDTO.getemailType();
...
//			Replace all the tags in the NotificationData.
            ...
            if(emailFormat != null) {
                notification.setType(emailFormat);
            }
